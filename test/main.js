(function() {
  var Module, crypto, fs, mime, path, redirPre, request, should, testfileMime, testfileName, testfileStream, url, utils, xmlParse, _config, _moduleInst;
